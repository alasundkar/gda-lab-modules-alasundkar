...
//	private IRequestResponseClient smtpClient = null;
	...
	public boolean handleSensorMessage(ResourceNameEnum resourceName, SensorData data)
	{
		...
		this.cloudClient.sendEdgeDataToCloud(ResourceNameEnum.CDA_ACTUATOR_CMD_RESOURCE, data);
		}
		catch(Exception ex) {
...
//		return true;
	...
	public void startManager()
	{
		...
		{			_Logger.info("Creating cloudClientConnector Object");
		...
		{
			MqttClientConnector mqttClient1 = new MqttClientConnector(true);
